  	...
  	<div class="container">
    	...
    	<div class="row">
        	<div class="col-md-12 text-center">
                ...
                <p class="lead">Doctor of Philosophy (PhD) Programme</p>
            </div>
        </div><!-- End row -->
        ...
        <div class="row" id="sub-header-features">
        	<div class="col-md-6">
                ...
                <p>Institute offers doctoral degree (PhD) programme in Computer Science & Engineering. The residence requirements for PhD program is four or six semesters depending on whether the student has M.Tech. or B.Tech. degree, respectively.</p>
                <!--<p><em>John - General Manager</em></p>-->
            </div>
            <div class="col-md-6">
            	<h2>What you will learn</h2>
                <p>The department is actively involved in research in all current areas of Computer Science. The focus of the PhD program is on research training with a high degree of specialization. The aim of such a training is to make our PhD students very competent in their respective areas, so that they may be able to take up teaching or research-and-development professions.</p>
                <ul class="list_ok">
  ...
  <section id="strips-course" class="style_2">
    ...
    <div class="col-md-4">
                    <div class="question_box">
                        <h3>Doctor of Philosophy (PhD) Programme</h3>
                       <ul>
				<li><a href="#">Apply Online</a></li>
				<li><a href="#">Seat Matrix</a></li>
				<li><a href="#">Fee Structure</a></li>
				<li><a href="#">Proforma for OBC Certificate</a></li>
			</ul>
			<p>
